...
class Trabajador extends REST_Controller{
	...
	{
		$users = $this->Trabajador_model->get_usuarios();
	...
	public function find_get($id)
	{
		...
		$user = $this->Trabajador_model->get_usuarios($id);
		if (! is_null($user) ) 
		{
	...
	public function index_delete($id)
	{
		...
		$delete = $this->Trabajador_model->delete($id);
